...
The files in `assets/img` are from [this version of Font Awesome by Dave Gandy](http://www.flaticon.com/packs/font-awesome/4), under the [Creative Commons Attribution 3.0](http://creativecommons.org/licenses/by/3.0/) license. The [main version of Font Awesome](http://fontawesome.io/) is under the [SIL Open Font License 1.1](http://scripts.sil.org/OFL).
...
The file in `assets/css/normalize.min.css` is from [Normalize.css](https://github.com/necolas/normalize.css), copyright © Nicolas Gallagher and Jonathan Neal, under the [MIT license](https://github.com/necolas/normalize.css/blob/master/LICENSE.md).

The file `component.js` includes `politespace.js` and the file `assets/_scss/lib/politespace.scss` is from [Politespace](https://github.com/filamentgroup/politespace), copyright © 2013 Zach Leatherman, under the [MIT license](https://github.com/filamentgroup/politespace/blob/master/LICENSE).

The file in `assets/js/vendor/html5shiv.js` is from [HTML5 Shiv](https://github.com/afarkas/html5shiv), copyright © 2014 Alexander Farkas (aFarkas), under the [MIT and GPL2 licenses](https://github.com/aFarkas/html5shiv/blob/master/MIT%20and%20GPL2%20licenses.md).

The file in `assets/js/vendor/jquery-1.11.3.min.js` is from [jQuery](https://jquery.com/), copyright © 2015 The jQuery Foundation, under the [MIT license](https://jquery.org/license/).

The file in `assets/js/vendor/rem.min.js` is from [REM unit polyfill](https://github.com/chuckcarpenter/REM-unit-polyfill), copyright © 2015 Chuck Carpenter, under the [MIT license](https://github.com/chuckcarpenter/REM-unit-polyfill/blob/master/LICENSE.md).

The file in `assets/js/vendor/respond.js` is from [Respond.js](https://github.com/scottjehl/Respond), copyright © 2012 Scott Jehl, under the [MIT license](https://github.com/scottjehl/Respond/blob/master/LICENSE-MIT).

The file in `assets/js/vendor/selectivisr-min.js` is from [Selectivizr](http://selectivizr.com/), copyright © Keith Clark, under the [MIT license](http://opensource.org/licenses/mit-license.php).

The files in `assets-styleguide/js/vendor/prism.js` and `assets-styleguide/css/prism.css` is from [Prism](http://prismjs.com/), copyright © 2012-2013 Lea Verou, under the [MIT license](https://github.com/PrismJS/prism/blob/gh-pages/LICENSE).
