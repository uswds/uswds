...
1. Download the [USWDS package](https://github.com/uswds/uswds/releases/download/v3.4.0/uswds-uswds-3.4.0.tgz) directly from the latest USWDS release and uncompress that file.
