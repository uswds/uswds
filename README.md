...
* Developers: Follow the instructions in this README to get started.
    * [CSS, JavaScript, image, and font files of all the assets on this site are available for download](https://github.com/18F/web-design-standards/releases/download/v0.13.0/uswds-0.13.0.zip).
...
[https://github.com/18F/web-design-standards/releases/download/v0.13.0/uswds-0.13.0.zip](https://github.com/18F/web-design-standards/releases/download/v0.13.0/uswds-0.13.0.zip)
