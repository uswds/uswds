...
- Core PR #6951: moved nine color-function descriptions below imports and directly above their functions as SassDoc. Corrected the radius() token description. Focused Sass output-equivalence checks passed.
