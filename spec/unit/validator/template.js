...
var template = [
  '<div>',
    ...
    '<input id="password" name="password" type="password" ',
      'aria-describedby="validation_list" class="js-validate_password" ',
      'data-validate-length=".{8,}" data-validate-uppercase="[A-Z]" ',
      'data-validate-numerical="\\d" data-validation-element="#validation_list">',
  '</div>',
].join('');
