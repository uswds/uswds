...
const toggleNav = (active) => {
  ...
  inPageNavigation.focusTrap.update(safeActive);
...
const resize = () => {
  ...
  if (isActive() && closer && closer.getBoundingClientRect().width === 0) {
    ...
    inPageNavigation.toggleNav.call(closer, false);
  }
};

const onMenuClose = () => inPageNavigation.toggleNav.call(inPageNavigation, false);
...
inPageNavigation = behavior(
  {
    [CLICK]: {
      ...
      [NAV_LINKS]() {
        ...
        if (isActive()) {
          inPageNavigation.toggleNav.call(inPageNavigation, false);
        }
      },
    },
    keydown: {
  ...
  },
  {
    init(root) {
      ...
      if (trapContainer) {
        inPageNavigation.focusTrap = FocusTrap(trapContainer, {
          Escape: onMenuClose,
        });
      }
