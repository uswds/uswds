...
This issue is used to request role changes within the USWDS repository contributor ladder, including promotions from Contributor to Maintainer or transitions to Alumni status. Please fill out this issue to file the request AND make a pull request to the `COMMUNITY.md` file with the role update.
...
<!-- TODO: Link the pull request updating your role in USWDS's COMMUNITY.md -->
...
- [ ] Running or helping to run events
...
- [ ] Proposing contributions to strategy and policy of the product and repository
- [ ] Participating in, and leading, community discussions
- [ ] Mentoring new Contributors
- [ ] Mentoring other Maintainers

#### Alumni Role:
*As Alumni, I acknowledge that I am*:
...
- [ ] Role change aligns with USWDS repository needs
