$(function(){
  ...
  var generateCodeSnippets = function(content, previewBox) {
    ...
    this.render = function(previewBox, sampleCode) {
      ...
      var sampleCodeBox = $('<div class="usa-accordion"><ul class="usa-unstyled-list"><li><button class="usa-button-unstyled" aria-expanded="false" aria-controls="collapsible-0">Toggle code</button><div id="collapsible-0" aria-hidden="true" class="usa-accordion-content"><pre><code class="language-markup"></code></pre></div></li></ul></div>');
