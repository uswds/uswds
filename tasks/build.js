...
const { copyTheme, copyFonts, copyMaterialIcons, copyUSWDSIcons, copyImages, copySass } = require("./copy");
...
exports.build = series(
  ...
  cleanDist,
  parallel(copyTheme, copyImages, copyFonts, copyMaterialIcons, copyUSWDSIcons, copySass),
  buildSprite,
  compileJS,
  compileSass
);
