...
const { copyTheme, copyFonts, copyMaterialIcons, copyPackageIcons, copyImages, copySass } = require("./copy");
...
exports.build = series(
  ...
  cleanDist,
  parallel(copyTheme, copyImages, copyFonts, copyMaterialIcons, copyPackageIcons, copySass),
  buildSprite,
  compileJS,
  compileSass
);
