...
const { copyTheme, copyFonts, copyIconSrc, copyIconSet, copyImages, copySass } = require("./copy");
...
exports.build = series(
  ...
  cleanDist,
  parallel(copyTheme, copyImages, copyFonts, copyIconSrc, copyIconSet, copySass),
  buildSprite,
  compileJS,
  compileSass
);
