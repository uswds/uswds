...
<ul class="usa-content-list">
  ...
  <li>Keep your form blocks in a vertical pattern. This approach is ideal, from an accessibility standpoint, because of imited vision that makes it hard to scan from right to left.</li>
</ul>
