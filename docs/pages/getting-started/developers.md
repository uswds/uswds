...
* **Global variables** are defined in the `_defaults.scss` file. Custom theming can be done by copying the `_variables.scss` file into your own project's Sass folder, changing variable values, and importing it before uswds in Sass.
