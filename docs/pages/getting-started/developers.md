...
* **Global variables** are defined in the `_defaults.scss` file. Custom theming can be done by copying `_variables.scss` into your own project's Sass folder, changing applicable variable values, and importing it before uswds in Sass.
