...
USWDS is supported by a dedicated team of individuals fulfilling various roles to ensure its success, security, and alignment with government standards and agency goals.
...
1. Any current contributor may become a new Maintainer, by meeting the requirements, and opening a PR against the root of the USWDS adding the themselves as a maintainer in the COMMUNITY.md file and corresponding team in the CODEOWNERS.md file.
...
1. Any current maintainer may become an alumni, by meeting the requirements, and opening a PR against the root of the USWDS adding the themselves in the alumni list in the COMMUNITY.md file.
